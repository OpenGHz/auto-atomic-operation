...
from .mcap_sources import (
    _FLB_MESSAGE_ENCODING,
    _FLB_POSE_IN_FRAME_SCHEMA,
    McapDemo,
    _align_optional_scene_joint,
    _align_samples_to_times,
    _canonicalize_foxglove_names,
    _decode_foxglove_joint_states,
    _decode_foxglove_pose_in_frame,
    ...
    _resolve_foxglove_joint_topic,
    _stack_joint_positions,
)
...
class DataReplayTaskFileConfig(TaskFileConfig):
    ...
    def _disable_object_randomization(self):
        ...
        self.task.randomization_groups.clear()
        return self
